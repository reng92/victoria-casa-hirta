...
const sections = [
  ...
  { href: "/admin/sponsors", emoji: "💰", label: "Sponsor", desc: "Gestisci gli sponsor e i loro loghi" },
  { href: "/admin/loghi", emoji: "🛡️", label: "Loghi avversari", desc: "Un logo per ogni squadra affrontata" },
